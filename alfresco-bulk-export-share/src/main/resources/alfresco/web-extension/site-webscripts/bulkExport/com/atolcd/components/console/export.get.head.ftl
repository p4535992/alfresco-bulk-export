...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/bulk-export/components/console/export.css" />
...
<@script type="text/javascript" src="${url.context}/res/bulk-export/components/console/export.js"></@script>
